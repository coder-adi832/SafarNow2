...
import user from '../assets/images/user-fill.png'
const MainPage = () => {
  ...
  return (
    <div className='h-screen w-screen relative overflow-hidden'>
      ...
      <div className='fixed w-full p-3 z-10 bottom-0 translate-y-full bg-white'>
          <h3 className='text-2xl font-semibold mb-5' >Choose a Vehicle</h3>
          <div className='mb-3 flex w-full items-center justify-between px-3 py-1 border-2 border-[#eee]  active:border-black rounded-2xl'>
            <img className='h-12' src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_368,w_552/v1714472148/assets/95/a05538-918b-42d8-afe7-3c92325f2fd4/original/UberLux.png" alt="" />
            <div className='w-1/2'>
              <h4 className='flex gap-2 text-sm'>MiniGo <span className='flex gap-1'><img className='h-5' src={user} alt="" />4</span></h4>
          ...
          <div className='mb-3 flex w-full items-center justify-between px-3 py-1 border-2  border-[#eee]  active:border-black  rounded-2xl'>
            ...
            <div className='w-1/2'>
              <h4 className='flex gap-2 text-sm'>Quick Ride <span className='flex gap-1'><img className='h-5' src={user} alt="" />1</span></h4>
              <h5 className='text-sm'>2 mins away</h5>
              <p className='text-xs'>Affordable, compact rides</p>
            </div>
          ...
          <div className='mb-3 flex w-full items-center justify-between px-3 py-1 border-2  border-[#eee]  active:border-black  rounded-2xl'>
            ...
            <div className='w-1/2'>
              <h4 className='flex gap-2 text-sm'>Desi Ride <span className='flex gap-1'><img className='h-5' src={user} alt="" />3</span></h4>
              <h5 className='text-sm'>2 mins away</h5>
              <p className='text-xs'>Affordable, compact rides</p>
            </div>
